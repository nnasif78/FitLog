...
export default function WorkoutActions({ workout }: { workout: Workout }) {
    ...
    return (
        <div className="flex flex-col gap-3 min-[480px]:flex-row">
            ...
            >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 21l-6-3.5L6 21V6a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v15z" /></svg>
