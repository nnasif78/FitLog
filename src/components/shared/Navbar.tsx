        ...
        <nav className="sticky top-0 h-[80px] w-full border border-white/10 border-b border-[#1C1F26] bg-black/20 backdrop-blur-xl">
            <div className="mx-auto flex h-full max-w-[1280px] items-center px-8">
                ...
                <div className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-1 sm:flex">
                    <Link href="/" className={`cursor-pointer rounded-xl px-3 py-1 text-[12px] font-medium leading-5 ${pathname === "/" ? "bg-[#1A2312] text-[#C2F800]" : "text-white"}`}>
                        Workouts
                    </Link>

                    <Link href="/my-plan" className={`cursor-pointer rounded-xl px-3 py-1 text-[12px] font-medium leading-5 ${pathname === "/my-plan" ? "bg-[#1A2312] text-[#C2F800]" : "text-white"}`}>
                        My Plan
                    </Link>
                </div>
