            ...
            <main className="mx-auto w-full max-w-[1280px] flex-1 px-5 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12">
                ...
                <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex w-fit cursor-pointer rounded-lg bg-[#232732] p-1">
                        ...
                        <button
                            ...
                            className={activeTab === "saved" ? "cursor-pointer rounded-md border border-[#2B303D] bg-[#1F242D] px-4 py-2 font-[family-name:var(--font-inter)] text-[12px] font-bold text-white" : "cursor-pointer px-4 py-2 font-[family-name:var(--font-inter)] text-[12px] font-normal text-[#8A92A0]"}
                        >
                            Saved
                        </button>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-[100px] appearance-none rounded-2xl border border-[#232732] bg-[#13161D] px-2 py-2 pr-4 text-center font-[family-name:var(--font-inter)] text-[12px] text-white outline-none"
                            >
                ...
                {workouts.length === 0 ? (
                    <div className="mt-6 flex h-[300px] w-full flex-col items-center justify-center rounded-xl border border-dashed border-[#2D3139] bg-[#111317] text-center">
                        ...
                        <p className="mt-2 font-[family-name:var(--font-inter)] text-[12px] font-normal text-[#8A92A0]">
                            Browse the library and add a lift to get today moving.
                        </p>

                        <Link
                            href="/#library"
                            className="mt-5 rounded-full bg-[#CCFF00] px-5 py-2 font-[family-name:var(--font-inter)] text-[12px] font-semibold text-black"
                        >
                            Go to workouts
                        </Link>
                    </div>
                    ...
                    <div className="mt-6 space-y-3">
                        {workouts.map((workout) => (
                            <div
                                key={workout.id}
                                className="flex min-h-[114px] flex-col gap-4 rounded-xl bg-[#13161D] p-4 min-[768px]:h-[114px] min-[768px]:flex-row min-[768px]:items-center min-[768px]:gap-0"
                            >
                                <img
                                    src={workout.image}
                                    alt={workout.name}
                                    className="h-40 w-full rounded-xl object-cover min-[768px]:h-20 min-[768px]:w-36"
                                />

                                <div className="ml-0 min-w-0 flex-1 min-[768px]:ml-4">
                                    <h3 className="truncate font-[family-name:var(--font-inter)] text-[16px] font-bold text-white">
                                        {workout.name}
                                    </h3>

                                    <p className="mt-1 truncate font-[family-name:var(--font-inter)] text-[12px] font-semibold text-[#8A92A0]">
                                        {workout.equipment}
                                    </p>

                                    <div className="mt-3 flex flex-wrap gap-3 font-[family-name:var(--font-inter)] text-[12px] text-[#8A92A0] sm:gap-4">
                                        <span className="flex items-center gap-1.5">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#CCFF00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <span className="flex items-center gap-1.5">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="#CCFF00" stroke="#CCFF00" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <span className="flex items-center gap-1.5">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#CCFF00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                            </svg>
                                            {workout.rating}
                                        </span>
                                    </div>
                                ...
                                <div className="flex w-full flex-wrap items-center gap-1.5 min-[768px]:w-auto min-[768px]:flex-nowrap min-[768px]:gap-2">
                                    <Link
                                        ...
                                        className="shrink-0 rounded-full border border-[#374151] px-3 py-1.5 font-[family-name:var(--font-inter)] text-[11px] text-white sm:px-4 sm:py-2 sm:text-[12px]"
                                    >
                                        View Details
                                    </Link>
                                    ...
                                    {activeTab === "today" && (
                                        <button
                                            ...
                                            className="shrink-0 cursor-pointer rounded-full bg-[#C2F800] px-3 py-1.5 font-[family-name:var(--font-inter)] text-[11px] font-bold text-[#0F1115] sm:px-4 sm:py-2 sm:text-[12px]"
                                        >
                                            Mark as Done
                                        </button>
                                    )}
