                            ...
                            <div className="flex w-full flex-wrap items-center gap-1.5 min-[768px]:w-auto min-[768px]:flex-nowrap min-[768px]:gap-2">
                                ...
                                {activeTab === "today" && (
                                    <button onClick={() => { removeFromPlan(workout.id); toast.success("Workout marked as done") }}
                                        className="shrink-0 cursor-pointer rounded-full bg-[#C2F800] px-3 py-1.5 font-[family-name:var(--font-inter)] text-[11px] font-bold text-[#0F1115] sm:px-4 sm:py-2 sm:text-[12px]">✓ Mark as Done</button>
                                )}
                                <button
                                    onClick={() => {
                                        if (activeTab === "today") {
